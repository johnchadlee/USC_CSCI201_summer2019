...
<body>
	...
	<!-- Login form -->
	<div class="login">
		<img src="Images/avator.jpg" alt="Avator" class="avator">
			<form action="SignupServlet" method="POST">
			  <div class="box">
			    <label for="uname"><b>Username</b></label>
			    <input type="text" placeholder="Enter Username" name="uname" onblur="validateUsername();" required>
			    <label for="psw"><b>Password</b></label>
			    <input type="password" placeholder="Enter Password" name="psw"  onblur="validatePassword();" required>
			    <label for="cpsw"><b>Confirm Password</b></label>
			    <input type="password" placeholder="Enter Password" name="cpsw" onblur="validatePassword();" required>
