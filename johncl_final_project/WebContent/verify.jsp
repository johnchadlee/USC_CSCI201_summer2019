      ...
      <div class="container">
        <div class="row slider-text align-items-center justify-content-center">
          <div class="col-lg-9 text-center col-sm-12 element-animate">
             <div class="section">
             <h1 class="mb-4" >One Last Step ...</h1>
             <h1 class="mb-4" style = "font-size: 20px; padding-bottom: 50px;"><br />A verification code has been sent to your email<br />Please copy and paste it here</h1>
    <div class="container" style = "float: center;">
      <div class="row" style = "text-align: center; display: inline-block; margin-left: 30px; margin-top: -30px;">
          ...
          <form action="VerifyServlet" method="GET">
            <div class="row">
              <div class="col-md-12 form-group">
                ...
                <input type="text" name="verify" id="verify" class="form-control " style = "width: 400px; margin-left: -30px;">
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 form-group">
              		...
              		<%
					String errormsg = (String)request.getSession().getAttribute("emailerrormsg");
                ...
                <input type="submit" id = "submitBtn" value="Verify" class="btn btn-primary px-3 py-3" style = "display: inline-block; text-align: center; margin-left: 120px; margin-top: 20px;">
